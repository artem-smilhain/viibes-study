    ...
    <section id="data">
        <div class="viibes__wrap">
            ...
            <div class="data">
                <div class="student">
                    <div class="inner">
                        <h2>Artem Smilhain</h2>
                        <div>
                            <p>Смилгаин Артем Андреевич</p>
                            <p>Абитуриент</p>
                        </div>
                    </div>
                    <a href="/my/data/applicant" class="viibes__btn_link">
                        Полная информация
                ...
                <div class="parent">
                    <div class="inner">
                        <h2>Olena Boiatiuk</h2>
                        <div>
                            <p>Смилгаин Артем Андреевич</p>
                            <p>Родитель</p>
                        </div>
                    </div>
                    <a href="/my/data/parent" class="viibes__btn_link">
                        Полная информация
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
