<section class="viibes__cards" id="cards_benefits">
    <div class="viibes__wrap">
        <h2 class="viibes__h2">
            Учеба в Словакии - лучший вариант для абитуриента. Это <span class="viibes__color_purple">самый простой способ получить диплом и ВНЖ Евросоюза </span>🇪🇺 🇸🇰
        </h2>
        <div class="viibes__cards_main">
            <div class="viibes__cards_column">
                <div class="viibes__cards_item">
                    ...
                    <h4 class="viibes__h4">Европейский диплом - твоя гарантия перспективного будущего</h4>
                ...
                <div class="viibes__cards_item">
                    ...
                    <p class="viibes__text_normal">Международные конкурсы, хакатоны, киберматчи и другие многочисленные мероприятия - неотъемлемая часть студентческой жизни в Словакии. Вы сможете податься на стажировку или обучение в другой стране по программе Erasmus+</p>
                </div>
            ...
            <div class="viibes__cards_column">
                ...
                <div class="viibes__cards_item">
                    ...
                    <p class="viibes__text_normal">Словацкий и русский принадлежат к одной языковой семье. Буквы словацкого алфавита читаются так же, как и пишутся, а многие слова похожи, имея лишь маленькие отличия. Потому людям из СНГ легче всего даётся изучение именно словацкого языка. Но мы советуем начать учить язык еще до переезда, чтобы легче социализироваться в обществе</p>
                </div>
            </div>
            <div class="viibes__cards_column">
                <div class="viibes__cards_item">
                ...
                <div class="viibes__cards_item">
                    ...
                    <p class="viibes__text_normal">C будущим дипломом европейского образца Вы сможете трудоустроиться почти в любой точке Мира </p>
