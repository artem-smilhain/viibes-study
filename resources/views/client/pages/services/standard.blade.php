    ...
    <section class="viibes__main"> <!-- MAIN CONTENT -->
        ...
        <div class="viibes__bg_gray service_page_item" style="background: #FFF2F6 !important;">
            <div class="viibes__wrap">
                ...
                <div class="viibes__text_medium service_page_item_list">
                    <div class="false"><span class="ico"></span>Онлайн-курсы словацкого языка с преподавателем на протяжении 5 месяцев по 3 раза в неделю</div>
                    <div class="false"><span class="ico"></span>Практикующие разговорные занятия на словацком языке со спикером</div>
                    <div class="false"><span class="ico"></span>Дополнительные авторские материалы для изучения языка</div>
                    <div class="false"><span class="ico"></span>Сдача внутреннего экзамена и получение сертификата о знании языка по окончании курсов</div>
                </div>
            </div>
        </div>
        <div class="viibes__bg_gray service_page_item">
