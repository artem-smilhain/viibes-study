...
@section('content')
    ...
    <div class="d-inline-flex justify-content-between w-100 align-items-center mt-3">
        <h4 class="">Специальности университетов Словакии 🤟</h4>
        <a href="{{ route('admin.programs.create') }}" class="btn btn-primary mb-3">Добавить специальность +</a>
    </div>
    <div class="mt-2 mb-1" style="font-size: 16px;">
    ...
    <div style="margin-bottom: 1rem;">
        <a href="{{ route('admin.programs.search-by-description') }}" class="text-success">Показать специальности с готовым описанием</a>
    </div>
    ...
    <div class="">
        {{ $programs->links('client.components.pagination') }}
    </div>
@endsection
