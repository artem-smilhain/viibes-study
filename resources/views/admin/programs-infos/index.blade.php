...
@section('content')
    ...
    <div class="d-inline-flex justify-content-between w-100 align-items-center mt-3">
        <h4 class="">Специальности для клиентов ⚡️</h4>
        <a href="{{ route('admin.program-info.create') }}" class="btn btn-primary mb-3">Создать документ +</a>
    </div>
    <div class="mb-3">
        <a href="{{ route('admin.programs.index-by-university') }}">Сортировать по университетам</a>
    </div>
    <table class="table table-bordered table-striped">
        ...
        <tbody>
        @php $i = 1; @endphp
        @foreach($programs_infos as $program_info)
            <tr>
