...
@section('content')
    <h4 class="mt-4">Редактировать направление ({{ old('name', $direction->name) }})</h4>
    <h6 class="mb-4">
    ...
    @foreach ($errors->all() as $error)
        <div>{{ $error }}</div>
    @endforeach
    <form method="post" action="{{ route('admin.directions.update', $direction) }}" enctype="multipart/form-data">
        @csrf
        {{ method_field('patch') }}
        <div class="row">
            ...
            <div class="input-field col-4">
                <div class="form-group">
                    ...
                    <input id="name_sk" name="name_sk" class="form-control @error('name_sk') is-invalid @enderror"
                           value="{{ old('name_sk', $direction->name_sk) }}" required>
                    @error('name_sk')
                    <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                    @enderror
                </div>
            ...
            <div class="input-field col-2">
                <div class="form-group">
                    ...
                    <input id="element_color" name="element_color" class="form-control @error('element_color') is-invalid @enderror"
                           value="{{ old('element_color', $direction->element_color) }}" required style="color: {{ old('element_color', $direction->element_color) }}">
                    @error('element_color')
                    <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                    @enderror
                </div>
            ...
            <div class="input-field col-2">
                <div class="form-group">
                    ...
                    <input id="row_weight" name="row_weight" type="number" class="form-control @error('row_weight') is-invalid @enderror"
                           value="{{ old('row_weight', $direction->row_weight) }}" required>
                    @error('row_weight')
                    <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                    @enderror
                </div>
            ...
            <div class="input-field col-12">
                ...
                <div class="form-group">
                    ...
                    <input id="meta_title" name="meta_title" class="form-control @error('meta_title') is-invalid @enderror"
                           value="{{ old('meta_title', $direction->meta_title) }}" required>
                    @error('meta_title')
                    <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                    @enderror
                </div>
            ...
            <div class="input-field col-12">
                <div class="form-group mb-4">
                    ...
                    <input id="meta_description" name="meta_description" class="form-control @error('meta_description') is-invalid @enderror"
                           value="{{ old('meta_description', $direction->meta_description) }}" required>
            ...
            <div class="input-field col-7">
                <div class="form-group">
                    ...
                    <textarea name="content_text" id="content_text" class="form-control" cols="30" rows="15">
                                {{ old('content_text', $direction->content_text) }}
                            </textarea>
                    @error('content_text')
                    <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                    @enderror
            ...
            <div class="col-5">
                <div class="input-field">
                    <div class="form-group">
                        ...
                        <input id="content_heading" name="content_heading" class="form-control @error('content_heading') is-invalid @enderror"
                               value="{{ old('content_heading', $direction->content_heading) }}" required>
                ...
                <div class="form-group">
                    ...
                    @if(!empty($direction->content_img_src))
                        <img src="{{ env('APP_URL') }}storage/{{ $direction->content_img_src }}" class="w-100 mt-2 rounded-4" alt="">
                    @endif
