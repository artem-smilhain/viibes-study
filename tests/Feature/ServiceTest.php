...
class ServiceTest extends TestCase
{
    ...
    public function testAdminCanCreateNewService()
    {
    ...
    public function testAdminCanUpdateServices()
    {
        Schema::disableForeignKeyConstraints();
        $this->classname::truncate();
        Schema::enableForeignKeyConstraints();
        ...
        $entity->name_ru = self::TITLE_FOR_UPDATE;
        $this->put(self::URL . '/' . $entity->id, $entity->toArray());
        $this->assertDatabaseHas(self::DB_TABLE_NAME, ['id' => $entity->id, 'name_ru' => self::TITLE_FOR_UPDATE]);

    }
    public function testAdminCanDeleteServices()
    {
        Schema::disableForeignKeyConstraints();
        $this->classname::truncate();
        $this->actingAs($this->admin);
