...
class ProgramTest extends TestCase
{
    ...
    const DB_TABLE_NAME = 'programs';
    const URL = 'admin/programs';
    const CLASSNAME = Program::class;
    ...
    public function testAdminCanCreateNewProgram()
    {
    ...
    public function testAdminCanUpdateProgram()
    {
        Schema::disableForeignKeyConstraints();
        $this->classname::truncate();
        Schema::enableForeignKeyConstraints();
    ...
    public function testAdminCanDeleteProgram()
    {
        Schema::disableForeignKeyConstraints();
        $this->classname::truncate();
        $this->actingAs($this->admin);
